...
import 'add_resrvation2_model.dart';
export 'add_resrvation2_model.dart';

class AddResrvation2Widget extends StatefulWidget {
  const AddResrvation2Widget({super.key});

  @override
  State<AddResrvation2Widget> createState() => _AddResrvation2WidgetState();
}

class _AddResrvation2WidgetState extends State<AddResrvation2Widget> {
  late AddResrvation2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddResrvation2Model());
