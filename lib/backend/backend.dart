...
import 'schema/gym_class_record.dart';
...
export 'schema/gym_class_record.dart';
export 'schema/reservation_record.dart';
export 'schema/user_record.dart';

/// Functions to query GymClassRecords (as a Stream and as a Future).
Future<int> queryGymClassRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      GymClassRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<GymClassRecord>> queryGymClassRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      GymClassRecord.collection,
      GymClassRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<GymClassRecord>> queryGymClassRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
